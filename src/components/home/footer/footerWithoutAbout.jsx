        ...
        <section className="col-xs-12 noPdSm footCategoryList">
          ...
          >
            <ul className="col-sm-3 footCategoryMobile">
              <a href="/men-clothing">
                <h4 className="fcWhite inline">Men's Clothing</h4>
              </a>
              <li>
                <a
            ...
            <ul className="col-sm-3 footCategoryMobile mt-[-134px]">
              <a href="/women-clothing">
                <h4 className="fcWhite inline">Women's Clothing</h4>
              </a>
              <li>
                <a
            ...
            <ul className="col-sm-3 footCategoryMobile mt-[-393px]">
              <a href="/mobile-covers-india">
                <h4 className="fcWhite inline">Mobile Covers</h4>
              </a>
              <li>
            ...
            <ul className="col-xs-12 col-sm-3 footerExtraLinks flex flex-col mt-[-493px]">
              <h4 className="col-sm-12 footCategoryMobile fcwhiteee">
